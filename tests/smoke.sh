...

{
  ...
  echo '{"jsonrpc":"2.0","id":7,"method":"tools/call","params":{"name":"org_edit_node_body","arguments":{"id":"x","content":"hi","operation":"frobnicate"}}}'
...
n = len(resp[2]["result"]["tools"]); assert n == 12, n; print(f"ok  tools/list ({n})")
...
assert resp[7]["result"]["isError"]; print("ok  org_edit_node_body error path")
print("\nSMOKE PASS")
PY
